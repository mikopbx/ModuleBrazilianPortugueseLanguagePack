...
namespace Modules\ModuleBrazilianPortugueseLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Brazilian Portuguese Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Brazilian Portuguese UI translations from Messages/pt_BR/ directory
 * - Brazilian Portuguese voice prompts from Sounds/pt-br/ directory
 *
 ...
 *
 * @package Modules\ModuleBrazilianPortugueseLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleBrazilianPortugueseLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Brazilian Portuguese packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Brazilian Portuguese Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Brazilian Portuguese Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Brazilian Portuguese Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Brazilian Portuguese Language Pack uninstalled successfully',
            LOG_INFO
        );
