...
namespace Modules\ModuleBrazilianPortugueseLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleBrazilianPortugueseLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * BrazilianPortugueseLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class BrazilianPortugueseLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-brazilian-portuguese-language-pack';
