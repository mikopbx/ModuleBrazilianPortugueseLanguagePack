...
namespace Modules\ModuleBrazilianPortugueseLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-brazilian-portuguese-language-pack/sounds
 *   GET /pbxcore/api/v3/module-brazilian-portuguese-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleBrazilianPortugueseLanguagePack';
