...
<div class="ui segment">
    <a class="ui basic compact button"
       href="{{ url('module-brazilian-portuguese-language-pack/module-brazilian-portuguese-language-pack/index') }}">
        <i class="left arrow icon"></i>{{ t._('mlp_pt_br_BackToOverview') }}
    </a>
    ...
    <div id="languagepack-sounds-table-container" style="margin-top: 1em;">
        <table class="ui selectable compact unstackable table" id="languagepack-sounds-table">
            <thead>
                <tr>
                    <th>{{ t._('mlp_pt_br_ColumnFile') }}</th>
                    <th class="cdr-player-column">{{ t._('mlp_pt_br_ColumnPlayer') }}</th>
                    <th>{{ t._('mlp_pt_br_ColumnConverted') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody></tbody>
    ...
    <div id="empty-table-placeholder" style="display:none">
        {{ partial("partials/emptyTablePlaceholder", [
            'icon': 'music',
            'title': t._('mlp_pt_br_EmptyTable'),
            'description': '',
            'showButton': false,
