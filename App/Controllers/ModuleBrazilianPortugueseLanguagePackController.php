...
namespace Modules\ModuleBrazilianPortugueseLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleBrazilianPortugueseLanguagePackController
 *
 * Controller for Brazilian Portuguese Language Pack module information page
 */
class ModuleBrazilianPortugueseLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleBrazilianPortugueseLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/pt-br';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/pt_BR';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-brazilian-portuguese-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-brazilian-portuguese-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-brazilian-portuguese-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-brazilian-portuguese-language-pack-sounds-index.js", true);
